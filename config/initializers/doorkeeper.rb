...
Doorkeeper.configure do
  ...
  # SB: Not using because we are doing machine to machine communication
  ...
  #   SB: Use JWT instead of opaque tokens
    access_token_generator '::Doorkeeper::JWT'
  ...
  # SB: Enable client credentials grant flow
